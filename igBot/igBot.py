...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            firefox_profile=firefoxProfile, executable_path=r"C:\Users\livia\OneDrive\Desktop\bot\geckodriver-v0.30.0-win64\geckodriver.exe"
        ) #alterar conforme caminho do geckodriver baixado
...
jhonatanBot = InstagramBot("username", "password")
jhonatanBot.login()        
